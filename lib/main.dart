...
import 'package:flutterinterviewtest/gsignin.dart';
import 'package:flutterinterviewtest/mylist.dart';
import 'package:flutterinterviewtest/phone_login.dart';
import 'package:flutterinterviewtest/tabbarView.dart';
import 'package:flutterinterviewtest/tabbardemo.dart';
  ...
  Future<FirebaseUser> _signIn(BuildContext context) async {
    ...
    Navigator.push(
      ...
      new MaterialPageRoute(
        builder: (context) => new MyAppTabBar(),
      ),
    );
                    ...
                    child: Align(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => MyAppPhone()),
                          );
                        },
                      ),
                    )
